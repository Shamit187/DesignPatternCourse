...
public class StudentAccount extends Account{
    ...
    public StudentAccount(String accountName, float initialDeposit) throws TransactionError {
    ...
    public void withdraw(float withdrawAmount) throws TransactionError {
        if(withdrawAmount > 10000.0f){
            throw new TransactionError("Student cannot withdraw more than 10,000$");
        }
    ...
    public void requestLoan(float requestedAmount) throws TransactionError {
        if(requestedAmount > 1000.0f){
            throw new TransactionError("Maximum allowable loan for Student Users.Accounts in 1,000$.");
